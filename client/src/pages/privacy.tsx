      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-white rounded-lg shadow-sm p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <p className="text-gray-700 mb-2">We collect information such as your name, email, phone number, and professional details when you use our services or register on our site.</p>
            ...
            <p className="text-gray-700 mb-6">We do not sell your data. Your information may be shared only with trusted partners necessary for providing our services.</p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">4. Cookies</h2>
            <p className="text-gray-700 mb-6">We use cookies to enhance your browsing experience and analyze site performance.</p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">5. Data Security</h2>
            <p className="text-gray-700 mb-6">We employ reasonable measures to safeguard your data from unauthorized access or misuse.</p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">6. Your Rights</h2>
            <p className="text-gray-700 mb-6">You can request access, correction, or deletion of your personal data by contacting us.</p>

            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">7. Contact</h2>
            <p className="text-gray-700 mb-6">For any privacy-related concerns, please email us at <a href="mailto:Admin@jobthrive.in" className="text-blue-600 hover:text-blue-800 underline">Admin@jobthrive.in</a>.</p>
          </div>
